...
<body bgcolor="">
  ...
  <div align="center" width="">
    <table class="head-wrap w320 full-width-gmail-android" cellpadding="0" cellspacing="0" border="0">
      ...
      <tr class="header-background">
        <td class="header" align="center" style="background-color: #29357b; color:aliceblue">
          <div class="content">
            <span class="brand">
                ...
                <td>
                  ...
                  <table class="body">
                    <tr>
                      ...
                      <div class="body-title">Hello {{$code->user->firstname}},</div>
                        <table class="body-text">
                          <tr>
                            <td class="body-text-cell">
                            <p>Welcome to Miraweb</p><br>

                                <p>To complete your registration and activate your account, click on the button below.</p><br>
                                <a href="{{$url}}"
                        style="background-color:#29357b;border:1px solid #29357b;border-radius:4px;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:17px;font-weight:bold;text-shadow: -1px -1px #29357b;line-height:38px;text-align:center;text-decoration:none;width:230px;-webkit-text-size-adjust:none;mso-hide:all;" id="log">Activate</a><br><br>

                            </td>
                          </tr>
                        </table>
    <p>This mail has been sent by you signing up on <a href="{{url('/')}}" target="_blank">Miraweb</a>. If this mail has been sent in error, please do ignore.</p>

                        <table class="body-signature-block">
                          <tr>
                            <td class="body-signature-cell">
                              <p>Thanks for choosing Miraweb</p>
                            </td>
                          </tr>
                        </table>
                      </td>
        ...
        <td class="container">
          <div class="content">
            ...
            <span class="footer-group">
              <a href="http://facebook.com/miraweb.ng" target="_blank">Facebook</a>&nbsp;&nbsp;|&nbsp;&nbsp;
              <a href="http://twitter.com/miraweb_ng" target="_blank">Twitter</a>&nbsp;&nbsp;|&nbsp;&nbsp;
              <a href="mailto:support@miraweb.com.ng">Support</a>
            </span>
          </div>
        </td>
        <td></td>
