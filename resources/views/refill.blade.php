...
<div class="gradient-bg title-wrap">
    <div class="row">
        <div class="col-lg-12 col-md-12 whitecolor">
            <h3 class="float-left"> Refill </h3>
            <ul class="breadcrumb top10 bottom10 float-right">
                <li class="breadcrumb-item hover-light"><a href="index.html">Home</a></li>
                <li class="breadcrumb-item hover-light">Refill</li>
            </ul>
        </div>
    </div>
</div>
...
<div class="row align-items-center">
    ...
    <div class="image"><img alt="SEO" src="{{asset('images-current/airtime.png')}}"></div>
    </div>
    <div class="col-lg-5 offset-lg-1 col-md-6 padding_bottom_half text-center text-md-left">
        <h2 class="darkcolor font-normal bottom30">Airtime, Data & Utility Refill</h2>
        <p class="bottom35"> Miraweb is one of the fastest growing Exchange Platform, registered under Nigeria’s
Corporate Affairs Commision with the name 'Miraweb Networks Limited` and RC Number 1709342. <br> <br> Our platform provides customer the opportunity to refill airtime, data and other utilities safely and smoothly. All payouts are automated and transactions are secured from end-to-end. <br>
        ...
        <div class="text-center text-md-right">
            <div class="feature-item mt-3 wow fadeInLeft" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInLeft;">
                ...
                <div class="text">
                    ...
                    <p>Exchange your bitcoin with high confidence and ease, as we assure you the highest level of encryption and professionally audited exchange system.</p>
                </div>
            </div>
            <div class="feature-item mt-5 wow fadeInLeft" data-wow-delay="350ms" style="visibility: visible; animation-delay: 350ms; animation-name: fadeInLeft;">
                ...
                <div class="text">
                    ...
                    <p>Exchange your bitcoin to naira instantly, We pay in Naira instantly within 5 minutes.
