...
class LoginSecurityController extends Controller
{
    ...
    public function enable2fa(Request $request){
        ...
        if($valid){
            ...
            return redirect()->back()->with('success',"2FA is enabled successfully.");
        }else{
    ...
    public function disable2fa(Request $request){
        if (!(Hash::check($request->get('current-password'), Auth::user()->password))) {
            ...
            return redirect()->back()->with("error","Password does not match your account password. Please try again.");
        }
        ...
        $user->loginSecurity->save();
        return redirect('/dashboard/account')->with('success',"2FA is successfully disabled.");
    }
}
