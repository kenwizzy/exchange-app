...
var App = function() {
    ...
    var handleQuickSidebarChat = function() {
        ...
        var handleChatMessagePost = function(e) {
            ...
            // handle post
            var time = new Date();
            var message = preparePost('out', (time.getHours() + ':' + time.getMinutes()), "Kiran Patel", '../assetss/img/dp', text);
            message = $(message);
            ...
            setTimeout(function() {
                var time = new Date();
                var message = preparePost('in', (time.getHours() + ':' + time.getMinutes()), "Jacob Ryan", '../assetss/img/user/user5', 'Lorem ipsum doloriam nibh...');
                message = $(message);
                chatContainer.append(message);
            }, 2000);
        };
    ...
    return {
        ...
        getassetssPath: function() {
            return assetssPath;
        },

        setassetssPath: function(path) {
            assetssPath = path;
        },
        ...
        getGlobalImgPath: function() {
            return assetssPath + globalImgPath;
        },

        getGlobalCssPath: function() {
            return assetssPath + globalCssPath;
        },
